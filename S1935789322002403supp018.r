...
names(OUT)<-c("concern","exps","infs","hosps","he", "statuses", "concern_ids")
 ...
 if(md < 10)
 {saveRDS(OUT, file.path(outputfolder,paste0("COV_", "nets",params1$NetSelect[nt],"mods0",params2$ModSelect[md],"rep",r,".RDS")))}
 if(md > 9)
 {saveRDS(OUT, file.path(outputfolder,paste0("COV_", "nets",params1$NetSelect[nt],"mods",params2$ModSelect[md],"rep",r,".RDS")))}
